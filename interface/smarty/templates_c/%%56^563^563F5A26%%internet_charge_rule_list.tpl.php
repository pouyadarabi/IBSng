...
smarty_core_load_plugins(array('plugins' => array(array('block', 'listTable', 'admin/charge/internet_charge_rule_list.tpl', 1, false),array('block', 'listTR', 'admin/charge/internet_charge_rule_list.tpl', 6, false),array('block', 'listTD', 'admin/charge/internet_charge_rule_list.tpl', 7, false),array('function', 'listTableHeaderIcon', 'admin/charge/internet_charge_rule_list.tpl', 3, false),array('function', 'arrayJoin', 'admin/charge/internet_charge_rule_list.tpl', 86, false),array('function', 'listTableBodyIcon', 'admin/charge/internet_charge_rule_list.tpl', 93, false),array('function', 'jsconfirm', 'admin/charge/internet_charge_rule_list.tpl', 96, false),array('modifier', 'escape', 'admin/charge/internet_charge_rule_list.tpl', 93, false),)), $this); ?>
<?php $this->_tag_stack[] = array('listTable', array('title' => 'Internet Charge Rule List','cols_num' => 12)); $_block_repeat=true;smarty_block_listTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<?php if ($this->_tpl_vars['can_change'] && ! $this->_tpl_vars['is_editing']): ?>
...
?>
		...
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['rule']['bw_tx_leaf_name']; ?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>

		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['rule']['bw_rx_leaf_name']; ?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>

		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['rule']['ras_description']; ?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo smarty_function_arrayJoin(array('array' => ($this->_tpl_vars['rule']['ports']),'glue' => ", ",'truncate' => 30), $this);?>
 
    		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo smarty_function_arrayJoin(array('array' => ($this->_tpl_vars['rule']['day_of_weeks']),'glue' => ", ",'truncate_each' => 3), $this);?>
...
&charge_name=<?php echo ((is_array($_tmp=$this->_tpl_vars['charge_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&delete_charge_rule=1"><?php echo smarty_function_listTableBodyIcon(array('action' => 'delete'), $this);?>
</a>
    		    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php endif; ?>
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTR($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
