<?php /* Smarty version 2.6.13, created on 2006-06-13 19:33:02
         compiled from admin/bw/interface_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'listTable', 'admin/bw/interface_list.tpl', 9, false),array('block', 'listTR', 'admin/bw/interface_list.tpl', 11, false),array('block', 'listTD', 'admin/bw/interface_list.tpl', 12, false),array('block', 'addRelatedLink', 'admin/bw/interface_list.tpl', 49, false),array('block', 'setAboutPage', 'admin/bw/interface_list.tpl', 67, false),array('function', 'listTableHeaderIcon', 'admin/bw/interface_list.tpl', 10, false),array('function', 'counter', 'admin/bw/interface_list.tpl', 29, false),array('function', 'listTableBodyIcon', 'admin/bw/interface_list.tpl', 42, false),array('modifier', 'escape', 'admin/bw/interface_list.tpl', 41, false),)), $this); ?>

<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "admin_header.tpl", 'smarty_include_vars' => array('title' => 'Interface List','selected' => 'Bandwidth')));
...
<?php $this->_tag_stack[] = array('listTable', array('title' => 'Interface List','cols_num' => 4)); $_block_repeat=true;smarty_block_listTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    foreach ($_from as $this->_tpl_vars['interface']):
?>
		...
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['interface']['interface_id']; ?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['interface']['interface_name']; ?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('listTD', array()); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <?php echo $this->_tpl_vars['interface']['comment']; ?>
		...
		<?php $this->_tag_stack[] = array('listTD', array('icon' => 'TRUE')); $_block_repeat=true;smarty_block_listTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		    <a href="/IBSng/admin/bw/interface_info.php?interface_name=<?php echo ((is_array($_tmp=$this->_tpl_vars['interface']['interface_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
">
...
<?php $this->_tag_stack[] = array('setAboutPage', array('title' => 'Interface List')); $_block_repeat=true;smarty_block_setAboutPage($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
